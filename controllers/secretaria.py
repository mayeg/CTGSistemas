...
class SecretariaController:
    ...
    def modificar_acta(self, titulo_acta, codigo, titulo, tipo, fecha, archivo,
        ...
        cod = session['usuario']['codigo']
        usuario = Usuario(nombres=session['usuario']['nombres'], codigo=cod)
        acta = Acta(codigo=codigo, titulo=titulo, tipo=tipo, fecha=fecha,
        ...
        if (ActaDao().modificar_acta(titulo_acta, acta)):
            ...
            return render_template(
                "secretaria/acta/Descargar-ModificarActa.html", usuario=usuario)
        else:
    ...
    def get_view_asignar_jurado_propuesta(self):
        ...
        return render_template("secretaria/propuesta/AsignarJuradosPropuesta.html",
                               propuestas=propuestas, jurados=jurados,
                               usuario=usuario)
    ...
    def asignar_jurado_propuesta(self, propuesta, jurado1, jurado2, jurado3):
        ...
        if (PropuestaDao().asignar_jurados(propuestaDividida[0], jurado1Dividido[1],
                                           jurado2Dividido[1], jurado3Dividido[1])):
    ...
    def get_view_asignar_jurado_trabajo(self):
        ...
        jurados = UsuarioDao().get_jurados(4)
        return render_template("secretaria/trabajoGrado/AsignarJuradosTrabajo.html",
                               trabajos=trabajos, jurados=jurados, usuario=usuario)
